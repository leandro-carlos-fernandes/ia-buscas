...
/**
 * Esta classe modela, na forma de um estado para um espaço de buscas, uma possível situação
 * para o famoso quebra-cabeças chamado 8-Puzzle. Nele temos um tabuleiro de três linhas e
 * três colunas, contendo oito peças numeradas e uma posição livre. As peças podem ser movi-
 * mentadas na vertical ou na horizontal, ocupando sempre a posição vazia.
 * 
 * Ex: +---+---+---+  +---+---+---+  +---+---+---+  +---+---+---+  +---+---+---+  +---+---+---+
...
public class Puzzle8 extends Estado<char[]> {
	...
	/**
	 * Construtor padrão. Cria uma instância para representar uma configuração
	...
	/**
	 * Permite criar um novo estado e definir, de imediato, qual é a configuração
	 * do tabuleiro que este estado representará. 
	...
	/**
	 * Permite criar um novo estado, definindo de imediato qual a configuração do
	 * tabuleiro, o estado que o gerou e também o nível em que este elemento ocupará
	 * na árvore de busca. 
	 * @param cfgTabuleiro vetor de caracteres que representa a disposição das peças.
